...
class KMeans:
    ...
    def calculate_clusters_for_dataset(self, X: list[list[float]], centroids: list[list[float]]) -> dict[int, list[list[float]]]:
    ...
    def is_stable(self, cs1: list[list[float]], cs2: list[list[float]], tol: Optional[float] = 1e-5) -> bool:
